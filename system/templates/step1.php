...
<form method="POST" role="form">
  ...
  <div class="checkbox">
    ...
    <label for="rules_agree">
      Погоджуюсь з <a href="https://dbr.gov.ua/poryadok-formuvannya-skladu-radi-gromadskogo-kontrolyu-pri-derzhavnomu-byuro-rozsliduvan"
      >умовами</a> проведення інтернет-голосування, зокрема<br>
      <br>
      ...
      Всі запити до системи голосування та адреси, звідки вони були зроблені - фіксуються.
    </label>
  </div>
  <br>
  <p>
    Якщо ви ще не ознайомились з кандидатами, будь ласка, нажміть <a href="index.php">На початок</a>.<br>
    Після продовження у вас буде 15 хвилин щоб обрати кандидатів або розпочати голосування з початку.
  </p>
  <br>
  <div>
